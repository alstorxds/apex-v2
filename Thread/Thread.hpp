...
std::string GamePathA = _(" C:\\Steam Epic\\steamapps\\common\\");
std::string GamePathB = _(" D:\\Steam Epic\\steamapps\\common\\");
std::string GamePathC = _(" E:\\Steam Epic\\steamapps\\common\\");
